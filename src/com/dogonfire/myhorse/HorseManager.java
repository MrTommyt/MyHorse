...
public class HorseManager {
    ...
    public Horse spawnHorse(UUID horseIdentifier, Location location) {
        ...
        try {
            ...
            OfflinePlayer ownerPlayer = this.plugin.getServer().getOfflinePlayer(ownerId.toString());
    ...
    public void setOwnerForHorse(UUID horseIdentifier, UUID ownerId) {
        if (ownerId == null) {
            ...
            Horse horse = getHorseEntity(horseIdentifier);
            if (horse != null) {
                OfflinePlayer player = this.plugin.getServer().getOfflinePlayer(ownerId.toString());
